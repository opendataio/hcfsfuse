  ...
  public static void main(String[] args) {
    ...
    try (final FileSystem fs = FileSystem.Factory.create(fsContext)) {
      ...
      if (conf.getBoolean(PropertyKey.FUSE_JNIFUSE_ENABLED)) {
        final AlluxioJniFuseFileSystem
            fuseFs = new AlluxioJniFuseFileSystem(fs, opts, conf);
        try {
        ...
        final AlluxioFuseFileSystem
            fuseFs = new AlluxioFuseFileSystem(fs, opts, conf);
        try {
