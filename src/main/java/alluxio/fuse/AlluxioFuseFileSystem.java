...
public final class AlluxioFuseFileSystem extends FuseStubFS {
  ...
  private final IndexedSet<OpenFileEntry<FileInStream, FileOutStream>>
      mOpenFiles;
  ...
  private int createInternal(String path, @mode_t long mode, FuseFileInfo fi) {
    ...
    try {
      ...
      SetAttributePOptions.Builder attributeOptionsBuilder = SetAttributePOptions
          .newBuilder();
  ...
  private int readInternal(String path, Pointer buf, @size_t long size, @off_t
      long offset,
      FuseFileInfo fi) {
  ...
  private int writeInternal(String path, Pointer buf, @size_t long size, @off_t
      long offset,
      FuseFileInfo fi) {
    if (size > Integer.MAX_VALUE) {
